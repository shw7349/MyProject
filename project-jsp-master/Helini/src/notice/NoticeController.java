	...
	private void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (action==null){	
				...
				Map articlesMap=noticeService.listArticles(pagingMap);
				articlesMap.put("section", section);
				articlesMap.put("pageNum", pageNum);
				request.setAttribute("articlesMap", articlesMap);
				nextPage = "/view/notice/listArticles.jsp";
				...
				nextPage = "/view/notice/articleForm.jsp";
				...
				List<Integer> articleNOList = noticeService.removeArticle(articleNO);
				...
				nextPage = "/view/notice/replyForm.jsp";
