...
public class NoticeDAO {
	...
	public List selectAllArticles() {
		...
		try {
			conn = dataFactory.getConnection();
			String query = "SELECT LEVEL,articleNO,parentNO,title,content,id,writeDate" + " from notice"
	...
	private int getNewArticleNO() {
		try {
			conn = dataFactory.getConnection();
			String query = "SELECT  max(articleNO) from notice ";
			System.out.println(query);
			pstmt = conn.prepareStatement(query);
	...
	public int insertNewArticle(NoticeVO article) {
		...
		try {
			...
			String query = "INSERT INTO notice (articleNO, parentNO, title, content, imageFileName, id, notice_yn)"
					+ " VALUES (?, ? ,?, ?, ?, ?, ?)";
			System.out.println(query);
			pstmt = conn.prepareStatement(query);
	...
	public void updateArticle(NoticeVO article) {
		...
		try {
			conn = dataFactory.getConnection();
			String query = "update notice  set title=?,content=?";
	...
	public void deleteArticle(int articleNO) {
		try {
			...
			query += "  SELECT articleNO FROM  notice ";
	...
	public List<Integer> selectRemovedArticles(int articleNO) {
		...
		try {
			conn = dataFactory.getConnection();
			String query = "SELECT articleNO FROM  notice  ";
			query += " START WITH articleNO = ?";
			query += " CONNECT BY PRIOR  articleNO = parentNO";
			System.out.println(query);
			pstmt = conn.prepareStatement(query);
	...
	public int selectTotArticles() {
		try {
			conn = dataFactory.getConnection();
			String query = "select count(articleNO) from notice ";
			System.out.println(query);
			pstmt = conn.prepareStatement(query);
			ResultSet rs = pstmt.executeQuery();
			if (rs.next())
