...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    $("form").on("submit", function () {
      ...
      //성별 확인
      if (
        member.mem_gender[0].checked == false &&
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <form action="memberJoin" method="post" role="form" id="usercheck" name="member">
                  ...
                  <div class="form-group">
                    <input class="form-control" style="width: 40%; display: inline" placeholder="우편번호" name="mem_zipcode"
                      id="mem_zipcode" type="text" readonly="readonly" />
                    <button type="button" class="btn btn-light" onclick="execPostcode();">
                      <i class="fa fa-search"></i>우편번호 찾기
                    </button>
                  </div>
                  <div class="form-group">
                    <input class="form-control" style="top: 5px" placeholder="도로명주소" name="mem_address" id="mem_address" type="text"
                      readonly="readonly" />
                  </div>
                  <div class="form-group">
